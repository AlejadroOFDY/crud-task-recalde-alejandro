...
export const updateTaskValidation = [
    ...
    body("tittle").optional().isEmpty().withMessage("El título no puede estar vacío"),
    body("description").optional().isEmpty().withMessage("La descripción no puede estar vacía"),
    body("isComplete").optional.isBoolean().withMessage("is Complete solo puede ser true o false")
]
